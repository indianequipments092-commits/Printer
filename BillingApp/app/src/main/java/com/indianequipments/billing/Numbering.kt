...
object Numbering {
    ...
    fun setInitialSequence(context:Context,next:Int){context.getSharedPreferences(PREF,Context.MODE_PRIVATE).edit().putInt("initial_seq",next.coerceAtLeast(1)).apply()}
